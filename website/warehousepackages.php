...
$sql="SELECT * FROM `booking` WHERE `track_id` IN (SELECT `track_id` FROM `tracking` WHERE `status`='Accepted' OR `status`='Packed')";
...
?>
    ...
    <td><?php echo $row["r_country"]; ?></td></tr>
<?php  
}
?>
