...
<center>
<div class="container"> <h2>Forget Password</h2> 
    ...
    <button type="submit" name="checkemail">Continue</button><br>
...
if(isset($_POST['checkemail'])){
    ...
    $run_sql = mysqli_query($con, "SELECT * FROM `customers` WHERE emailid='$email'");
    ...
    if(mysqli_num_rows($run_sql) > 0){
        ...
        $sender = "From: rolexcargojed@gmail.com";
        if(mail($email, $subject, $message, $sender)){
            $info = "We've sent a passwrod reset otp to your email - $email";
                ...
                echo "$a Failed while sending code! $b";
            }
        }else{
