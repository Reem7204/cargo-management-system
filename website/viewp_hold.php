...
?>
    ...
    <td>
        <button name='update'><a style='color:white;' href="delp_hold.php?id=<?php echo $row['track_id']; ?>">Update</a></button> </td></tr>
<?php  
}
?>
