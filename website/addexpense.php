...
<form action="" method="post">
    ...
    <table>
        <tr><th>Date</th>
        <th><input type="date" name="date1" style="width: 235px;" required></th></tr>

        <tr><th>Description</th>
        <th><input type="text" name="description" required></th></tr>

        <tr><th>Amount</th>
        <th><input type="text" name="amount" required></th></tr>
        </table>
...
<?php
    if (isset($_POST['submit'])){
        ...
        $sql="INSERT INTO `expense`( `date`, `description`, `amount`) VALUES ('$date1','$description','$amount')";

        $result=mysqli_query($con,$sql);
        if($result)
        {
            echo "<script>alert(' Entered sucessfull');window.location='addexpense.php'</script>";
         }
    }
