...
?>
    ...
    <td><button name='update'><a style='color:white;' href='updatecargotype.php?cargo_id=<?php echo $row['cargo_id'];?>'>Update</a></button> <button name='delete'><a style='color:white;' href="delete.php?id=<?php echo $row['cargo_id']; ?>">Delete</button></td></tr>
<?php  
}
?>
