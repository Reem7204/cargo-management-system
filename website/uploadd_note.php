...
$sql="SELECT * FROM `document` WHERE `deliverynote`=' '";
...
?>
    ...
    <td><button name='update'><a style='color:white;' href='uploaddoc2.php?id=<?php echo $row['track_id'];?>'>Upload</a></button></td></tr>
 <?php } ?>
