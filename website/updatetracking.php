...
$sql="SELECT * FROM tracking WHERE `status`!='Delivered'";
...
?>
    ...
    <td><button name='update'><a style='color:white;' href='updatestatus.php?id=<?php echo $row['track_id'];?>'>Update</a></button> </td></tr>
<?php  
}
?>
